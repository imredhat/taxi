                    ...
                    <div id="invoice" class="effect2">
                        ...
                        <strong></strong> پویش تاکسی<br>سامانه اينترنتي سواري دربستي
                            ...
                            <div class="title">
                                ...
                                <form method="post" action="<?=base_url()?>Pay/UserPayStart" style="margin-top: -10px;">
                                  <input type="hidden" name="amount" value="<?=$Trip['userCustomFare']?>" />
                                  <input type="hidden" name="name" value="<?=$Trip['passenger_name']?>" />
                                  <input type="hidden" name="mobile" value="<?=$Trip['passenger_tel']?>" />
                                  <input type="hidden" name="desc" value="پرداخت کرایه سفر #<?=1000+$Trip['id']?>" />
