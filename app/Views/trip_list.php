                ...
                <td>
                    <div class="dropdown action-opt">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end bg-white border box-shadow">
                            ...
                            <li>
                                <a data-bs-toggle="modal" data-bs-target="#TrancactionAddModal" class="dropdown-item" data-id="<?= $S['id'] ?>" data-dfare="<?= $S['driverCustomFare'] ?>" data-cfare="<?= $S['userCustomFare'] ?>" href="javascript:;">
