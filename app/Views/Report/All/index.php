                ...
                <div class="tab-content" id="myTab3Content">
                    <div class="tab-pane fade active show" id="preview4-tab-pane" role="tabpanel" aria-labelledby="preview4-tab" tabindex="0">
                        ...
                        <?php
                            ...
                            $print_url   = str_replace("All", "All/Print", $current_url);
                        ?>
                                <a href="<?php echo $print_url?>" class="btn btn-outline-success fw-semibold py-2 px-sm-4 hover-white print_btn">
