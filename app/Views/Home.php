                    ...
                    <div class="stats-box style-five style-five bg-white card border-0 rounded-10 mb-4">
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-center mb-4 pb-4"> <i
                                ...
                                <div class="text-end">
                                    <h4 class="mb-1 body-font fs-24"><?=number_format($IN);?> تومان</h4> <span>مجموع دریافتی</span>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between mb-2"> <span class="fw-semibold">هدف درآمد</span>
                                <span><?=number_format(1000000000);?> تومان</span> </div>
                            ...
                            if($All == 0){
                                ...
                                echo $Precent = ($IN/1000000000)*100;
                            }
                            ?>
                    ...
                    <div class="stats-box style-five style-five bg-white card border-0 rounded-10 mb-4">
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-center mb-4 pb-4"> <i
                                ...
                                <div class="text-end">
                                <h4 class="mb-1 body-font fs-24"><?=number_format($OUT);?> تومان</h4> <span>مجموع پرداختی</span>
                                </div>
                            </div>
                        ...
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between mb-4">
                                <div> <span class="fw-semibold">کل سفارشات</span> <span
                                        class="d-block fw-bold text-dark fs-24 mt-2"><?=number_format($TotalTrips)?></span> </div>
                        ...
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between mb-4">
                                <div> <span class="fw-semibold">درآمد کلی</span> <span
                                        class="d-block fw-bold text-dark fs-24 mt-2"><?= number_format($IN - $OUT)?> تومان</span> </div>
